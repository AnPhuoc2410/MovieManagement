...
namespace MovieManagement.Server.Services.MovieService
{
    public interface IMovieService
    {
        ...
        Task<IEnumerable<MoviePreview>> GetMoviesByNameRelativePage(string name, int page, int pageSize);
        ...
        Task<IEnumerable<MoviePreview>> GetMoviesByNameRelative(string searchValue);
    }
}
