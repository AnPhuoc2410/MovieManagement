  ...
  return (
    <Box sx={{ backgroundColor: "#0B0D1A", color: "white" }}>
      ...
      <Box textAlign="center" mt={2}>
        <Button onClick={() => {navigate("/movies/now-showing");}} variant="contained" color="warning" sx={{ mt: 2 }}>
          XEM THÊM
        </Button>
      </Box>
      ...
      <Box textAlign="center" mt={2}>
        <Button onClick={() => {navigate("/movies/upcoming");}} variant="contained" color="warning" sx={{ mt: 2 }}>
          XEM THÊM
        </Button>
      </Box>
    </Box>
