              ...
              >
                ...
                <form onSubmit={handleSubmit(handleFormSubmit)}>
                  ...
                  >
                    ...
                    <Box sx={{ flex: 1, maxWidth: 750 }}>
                        ...
                        render={({ field, fieldState: { error } }) => (
                          ...
                          >
                            <InputLabel id="demo-simple-select-label">
                              {t("movie_detail.input_label.age_class")}
                            </InputLabel>
                            <Select
                              {...field}
                      ...
                      <Controller
                        ...
                        render={({ field, fieldState: { error } }) => (
                          ...
                          >
                            <InputLabel id="demo-simple-select-label">
                              {t("movie_detail.input_label.version")}
                            </InputLabel>
                            <Select
                              {...field}
                              labelId="demo-simple-select-label"
                            ...
                            InputProps={{
                              endAdornment: (
                                <InputAdornment position="end">
                                  {t("movie_detail.input_label.minute")}
                                </InputAdornment>
                              ),
                              readOnly: !isEditing, // Make readonly if not editing
                            }}
                    ...
                    <Box>
                      <Controller
                        ...
                        control={control}
                        rules={{
                          required: t("movie_detail.required.image"),
                        }}
                        render={({ field, fieldState: { error } }) => (
                          <Box
                            component="section"
                  ...
                  <Controller
                    ...
                    rules={{
                      validate: (value) =>
                        value.length > 0 || t("movie_detail.required.category"),
                    }}
                    render={({ field, fieldState: { error } }) => (
                      <Box sx={{ mt: 2 }}>
                  ...
                  <Controller
                    ...
                    rules={{
                      ...
                      validate: (value) =>
                        value.trim() !== "" || t("movie_detail.required.content"),
                    }}
                    render={({ field, fieldState: { error } }) => (
                      <Box sx={{ mt: 1, mb: 2 }}>
                        {" "}
